...
- **[PAGES-STRUCTURE-GUIDE.md](./PAGES-STRUCTURE-GUIDE.md)** - Повний гайд по структурі HTML сторінок
- **[CODE-STYLE-GUIDE.md](./CODE-STYLE-GUIDE.md)** - Правила форматування та стилю коду
- **[ARCHITECTURE-VIOLATIONS-REPORT.md](./ARCHITECTURE-VIOLATIONS-REPORT.md)** - Звіт про знайдені порушення архітектури
