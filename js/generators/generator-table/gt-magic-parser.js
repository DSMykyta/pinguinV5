...
const NORMALIZATION_MAP = [
    ...
    // Трансжиры (підкатегорія)
    [/^(транс-?жиры|транс-?жирів|trans fat|trans)$/i,
     '- трансжиры', '- трансжири'],
    ...
    // Добавленный сахар (підпідкатегорія)
