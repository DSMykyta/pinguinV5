// js/pages/banned-words/banned-words-aside.js
...
registerAsideInitializer('aside-banned-words', () => {
    ...
    if (asideContainer) initCustomSelects(asideContainer);

    // Приховати кнопку фільтрів пошуку (показувати тільки на tab-manage)
