// js/components/editor/editor-charm-tooltip.js

/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  ✨ ШАРМ [check] — Підказки для заборонених слів та гарячих клавіш             ║
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║                                                                          ║
 * ║  Hover на підсвіченому слові → tooltip з поясненням.                     ║
 * ║  Hover на чіпі валідації → tooltip з поясненням.                         ║
