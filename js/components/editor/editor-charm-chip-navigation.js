// js/components/editor/editor-charm-chip-navigation.js

/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  ✨ ШАРМ [check] — Навігація по чіпах валідації                                ║
 * ╠══════════════════════════════════════════════════════════════════════════╣
 * ║                                                                          ║
 * ║  Клік на червоний чіп → перехід до слова в редакторі.                    ║
 * ║  Циклічна навігація: 1→2→3→1... Flash-ефект при переході.               ║
